    ...
    public class UserAccount
    {
        ...
        public static List<UserAccount> GetDummyUsers()
        {
            return new List<UserAccount>
            {
                ...
                new UserAccount { Username = "dayinta", Password = "123", Name = "Dayinta Palupi", Nopek = "2080", Role = "AM", PRL = "19", Section = "Asset Management", Position = "Manager Area Asset Management", Points = 800},
                new UserAccount { Username = "kerin", Password = "password4", Name = "Cecillia Kerin", Nopek = "2028", Role = "TKJP", PRL = "20", Section = "Maintenance", Position = "Manager Maintenance Planning & Support", Points = 810},
